  ...
  return (
    <div className=" dark m-2 my-2 rounded-3xl bg-midnight p-6 text-left sm:m-10">
      ...
      <header className="m-9 my-4 flex text-gray-500 sm:text-[1.25vw]">
        <h2
          id="title"
          className="flex w-4/12 items-center gap-1"
        ...
        <h2
          id="type"
          className="hidden w-3/12 items-center gap-1 sm:flex"
          onClick={(e) => sortingFunction(e)}
        >
          type
          {sorted === "type" ? (
        ...
        <h2
          id="amount"
          className="flex w-2/12 items-center gap-1"
          onClick={(e) => sortingFunction(e)}
        >
          amount
          {sorted === "amount" ? (
        ...
        <h2
          id="createdAt"
          className="ml-auto flex w-3/12 items-center gap-1 sm:m-0"
          onClick={(e) => sortingFunction(e)}
        >
          createdAt
          {sorted === "createdAt" ? (
