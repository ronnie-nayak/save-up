      ...
      <div className="w-full rounded-3xl bg-midnight p-9">
        <AspectRatio ratio={16 / 9}>
          <div className="flex flex-col sm:flex-row">
            <div className="mr-auto font-bold sm:text-[1.5vw]">Activities</div>
            <div className="mb-4 flex gap-4">
              <div className="flex items-center gap-1 sm:gap-3">
                <div className="h-4 w-4 rounded-full bg-[#5ABF41]"></div>
                <span className="text-[2.25vw] sm:text-[1vw]">Income</span>
              </div>

              <div className="flex items-center gap-1 sm:gap-3">
                <div className="h-4 w-4 rounded-full bg-[#FC3928]"></div>
                <span className="text-[2.25vw] sm:text-[1vw]">Expense</span>
              </div>
              <div className="flex items-center gap-1 sm:gap-3">
                <div className="h-4 w-4 rounded-full bg-[#1168C9]"></div>
                <span className="text-[2.25vw] sm:text-[1vw]">Savings</span>
              </div>
            </div>
          </div>
